...
// i should delete the white_spaces in the input then hash it using the 'sha256' algo  , comparing them to the values i have  .... 
...
$data_file_name = __DIR__ . '\Data_Hashed.txt';
;
;
